...
public class TestScreen extends UIScreen{
    ...
    public void wasAdded(){
        ...
        if(showDebugDraw){
            ...
            root5.add(new Label("You have 1:00 ").addStyles(Style.FONT.is(TestScreen.TITLE_FONT)).addStyles(Style.COLOR.is(0xFFFFFFFF)));
    ...
    public void update(int delta) {
        ...
        if(time2==1){
            ...
            root3.add(new Label("YourScore is "+thiscore).addStyles(Style.FONT.is(TestScreen.TITLE_FONT)).addStyles(Style.COLOR.is(0xFFFFFFFF)));
